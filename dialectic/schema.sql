...
-- ============================================================
-- EXTERNAL OPERATION LEDGER (migration 018)
-- ============================================================
-- Stable operation keys and short leases close the crash gap between a human
-- accepting a proposal here and a network write landing in another service.
