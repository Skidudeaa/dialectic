// Ported verbatim from God's Eye View (https://github.com/bilawalsidhu/gods-eye-view),
// MIT License, Copyright (c) 2026 Bilawal Sidhu. Only the export type annotation
// below is ours -- the GLSL is upstream's and is kept unedited so upstream fixes
// can be re-applied by diff. See docs/WORLD_PROVIDERS.md for the attribution.
 ...
 */
export const nightVisionShader: WorldShader = {
  name: 'surveillance',
  uniforms: {
